        ...
        <div className="pt-4">
          ...
          <div className="flex items-center gap-2">
            <div className="color-selector">
              ...
              <label
                htmlFor="red"
                className="border border-gray-200 rounded-sm h-6 w-6 cursor-pointer shadow-sm block bg-[#fc3d57]"
              ></label>
            </div>
            <div className="color-selector">
              ...
              <label
                htmlFor="black"
                className="border border-gray-200 rounded-sm h-6 w-6 cursor-pointer shadow-sm block bg[#000]"
              ></label>
            </div>
            <div className="color-selector">
              ...
              <label
                htmlFor="white"
                className="border border-gray-200 rounded-sm h-6 w-6 cursor-pointer shadow-sm block bg-[#fff]"
              ></label>
            </div>
          </div>
        </div>
